...
function AppointmentCalendar() {
  ...
  const handleAddOrUpdateSlot = async (e) => {
    ...
    try {
      if (editingSlot) {
        await axios.put(`http://localhost:3000/api/avahours/update/${editingSlot.id}/`, {
  ...
  return (
    <div className="p-8">
      <h1 className="text-4xl font-bold text-center mb-8">Appointment Calendar</h1>
