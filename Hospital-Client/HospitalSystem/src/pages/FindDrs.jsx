          ...
          <div className="relative ms-4">
            ...
            <div className="absolute bottom-0 start-0">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <rect fill="currentColor" height="99" width="99" x="531" y="352" />
                <rect fill="currentColor" height="99" width="106" x="140" y="352" />
                <rect fill="currentColor" height="49" width="64" x="482" y="402" />
                <rect fill="currentColor" height="49" width="63" x="433" y="402" />
                <rect fill="currentColor" height="50" width="49" x="384" y="352" />
                <rect fill="currentColor" height="50" width="50" x="531" y="328" />
                <rect fill="currentColor" height="58" width="49" x="99" y="303" />
                <rect fill="currentColor" height="50" width="49" x="99" y="352" />
                <rect fill="currentColor" height="59" width="49" x="99" y="392" />
                <rect fill="currentColor" height="49" width="66" x="44" y="402" />
                <rect fill="currentColor" height="49" width="62" x="234" y="402" />
                <rect fill="currentColor" height="49" width="50" x="334" y="303" />
                <rect fill="currentColor" height="49" width="49" x="581" />
                <rect fill="currentColor" height="64" width="49" x="581" />
                <rect fill="currentColor" height="49" width="49" x="482" y="123" />
                <rect fill="currentColor" height="24" width="49" x="507" y="124" />
                <rect fill="currentColor" height="99" width="99" x="531" y="49" />
              </svg>
            </div>
          </div>
        </div>
